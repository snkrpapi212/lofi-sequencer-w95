/**
 * ============================================
 * Lo-Fi Sequencer 95 - Unit Tests
 * ============================================
 * 
 * Unit tests for the LoFiSequencer class
 */
...
runner.test('Constructor initializes with default values', (t) => {
    const sequencer = new LoFiSequencer();
...
runner.test('Multiple sequencer instances are independent', (t) => {
    const sequencer1 = new LoFiSequencer({ bpm: 80 });
    const sequencer2 = new LoFiSequencer({ bpm: 100 });
...
if (typeof module !== 'undefined' && module.exports) {
    // Node.js environment
    module.exports = { TestRunner, MockAudioContext };
    // Tests will be run by a test runner
} else {
    // Browser environment
